...
# Problema: Printing Costs
# Problem ID: printingcosts
# Submissao: 6038637

import sys

printCosts = {' '  : 0    ,    '!' :  9     ,   '"'  : 6   ,     '#' : 24   ,     '$' : 29    ,    '%' : 22,
'&' : 24     ,    "'" :  3     ,   '(' : 12   ,     ')' : 12   ,     '*' : 17    ,    '+' : 13,
 ',' :  7    ,    '-' :  7     ,   '.' :  4   ,     '/' : 10   ,     '0' : 22    ,    '1' : 19,
...
for line in sys.stdin:
  	...
  	#varivavel para armazenar o preço total
    totalCosts=0
    
    #Laco para percorrer cada caracter
    for i in line:
        if ord(i)!=10:
            totalCosts += printCosts[i]
